...
void Cetakulang(queue Q)
{
	if(Q.first != -1)
	{
		...
		for(i=Q.last; i>Q.first; i--)
		{
			...
			cout << "Nama Pokok Mahasiswa     : " << Q.Dat[i].npm << endl;
...
int main() {
	...
	cout << endl;
	cout << "-------------------------------------------" << endl;
	ADD ("4525210111", "A", 11.22, &Q);
	ADD ("4525210222", "B", 33.44, &Q);
	ADD ("4525210333", "C", 55.66, &Q);
	ADD ("4525210444", "D", 77.88, &Q);
	ADD ("4525210555", "E", 99.11, &Q);
	ADD ("4525210666", "F", 22.33, &Q);
	ADD ("4525210777", "G", 44.55, &Q);
	CetakQueue(Q);
	cout << "=========================================================" << endl;
	cout << endl;
	cout << endl;
